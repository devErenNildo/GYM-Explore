        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 pb-4 border-b border-gray-700">
          <Box className="flex flex-col items-start mb-4 md:mb-0">
            ...
            <Typography
              ...
              data-testid="footer-about-us-text"
            >
              {t("aboutUsText")}
            </Typography>
          ...
          <Box className="text-left mb-4 md:mb-0">
            <Typography
              variant="h6"
              className="text-white font-semibold mb-2 text-sm md:text-base"
                  ...
                  >
                    <ListItemText
                      ...
                      primaryTypographyProps={{
                        className:
                          "text-gray-400 hover:text-accent transition-colors cursor-pointer text-xs",
                      }}
                    />
                  </Link>
                </ListItem>
          ...
          <Box className="text-left mb-4 md:mb-0">
            <Typography
              variant="h6"
              className="text-white font-semibold mb-2 text-sm md:text-base"
              data-testid="footer-contact-us-title"
            >
              {t("contactUsTitle")}
            </Typography>
            <Typography
              variant="body2"
              className="text-gray-400 mb-0.5 text-xs"
          ...
          <Box className="hidden lg:block text-left mb-4 md:mb-0">
            <Typography
              variant="h6"
              className="text-white font-semibold mb-2 text-sm md:text-base"
              data-testid="footer-legal-links-title"
            >
              {t("quickLinksTitle")}
            </Typography>
            <List disablePadding>
